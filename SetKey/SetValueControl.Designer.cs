namespace RedisGuiManager
{
    partial class SetValueControl
    {
        ...
        private void InitializeComponent( )
        {
			...
			this.dataGridView_set = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.dataGridView_set)).BeginInit();
			this.SuspendLayout();
			// 
			// splitContainer1
			// 
			...
			this.splitContainer1.Panel1.Controls.Add(this.dataGridView_set);
			// 
			...
			this.checkBox_search_grep.TabIndex = 21;
			...
			this.label_length_val.Location = new System.Drawing.Point(284, 6);
			...
			this.label_size.Location = new System.Drawing.Point(71, 6);
			...
			// dataGridView_set
			// 
			this.dataGridView_set.AllowUserToAddRows = false;
			this.dataGridView_set.AllowUserToDeleteRows = false;
			this.dataGridView_set.AllowUserToResizeRows = false;
			dataGridViewCellStyle1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(235)))), ((int)(((byte)(235)))), ((int)(((byte)(255)))));
			this.dataGridView_set.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
			this.dataGridView_set.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.dataGridView_set.BackgroundColor = System.Drawing.Color.White;
			this.dataGridView_set.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridView_set.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.Column_index,
            this.Column_value});
			this.dataGridView_set.Location = new System.Drawing.Point(3, 26);
			this.dataGridView_set.MultiSelect = false;
			this.dataGridView_set.Name = "dataGridView_set";
			this.dataGridView_set.ReadOnly = true;
			this.dataGridView_set.RowHeadersVisible = false;
			this.dataGridView_set.RowTemplate.Height = 23;
			...
			this.keyOperateControl.KeyType = "Set:";
			...
			this.Name = "SetValueControl";
			this.Size = new System.Drawing.Size(847, 610);
			this.Load += new System.EventHandler(this.SetValueControl_Load);
			this.splitContainer1.Panel1.ResumeLayout(false);
			this.splitContainer1.Panel1.PerformLayout();
			this.splitContainer1.Panel2.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.splitContainer1)).EndInit();
			this.splitContainer1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGridView_set)).EndInit();
		...
		private System.Windows.Forms.DataGridView dataGridView_set;
